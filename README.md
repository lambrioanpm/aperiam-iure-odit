...
[![Build Status](https://github.com/lambrioanpm/aperiam-iure-odit/workflows/CI-CD/badge.svg?branch=master)](https://github.com/lambrioanpm/aperiam-iure-odit/actions)
[![Coverage Status](https://coveralls.io/repos/github/lambrioanpm/aperiam-iure-odit/badge.svg?branch=master)](https://coveralls.io/github/lambrioanpm/aperiam-iure-odit)
[![Tested on APIs.guru](https://api.apis.guru/badges/tested_on.svg)](https://apis.guru/browse-apis/)

[![npm](https://img.shields.io/npm/v/@lambrioanpm/aperiam-iure-odit.svg)](https://www.npmjs.com/package/@lambrioanpm/aperiam-iure-odit)
[![Dependencies](https://david-dm.org/lambrioanpm/aperiam-iure-odit.svg)](https://david-dm.org/lambrioanpm/aperiam-iure-odit)
[![License](https://img.shields.io/npm/l/@lambrioanpm/aperiam-iure-odit.svg)](LICENSE)
[![Buy us a tree](https://img.shields.io/badge/Treeware-%F0%9F%8C%B3-lightgreen)](https://plant.treeware.earth/lambrioanpm/aperiam-iure-odit)

[![OS and Browser Compatibility](https://apitools.dev/img/badges/ci-badges-with-ie.svg)](https://github.com/lambrioanpm/aperiam-iure-odit/actions)
...
- **[Tested](https://github.com/lambrioanpm/aperiam-iure-odit/actions)** in Node.js and all modern web browsers on Mac, Windows, and Linux
...
```bash
npm install @lambrioanpm/aperiam-iure-odit
```
...
```javascript
const SwaggerParser = require("@lambrioanpm/aperiam-iure-odit");
```

When using a transpiler such as [Babel](https://babeljs.io/) or [TypeScript](https://www.typescriptlang.org/), or a bundler such as [Webpack](https://webpack.js.org/) or [Rollup](https://rollupjs.org/), you can use **ECMAScript modules** syntax instead:

```javascript
import * as SwaggerParser from '@lambrioanpm/aperiam-iure-odit';
```
...
Contributing
--------------------------
I welcome any contributions, enhancements, and bug-fixes.  [Open an issue](https://github.com/lambrioanpm/aperiam-iure-odit/issues) on GitHub and [submit a pull request](https://github.com/lambrioanpm/aperiam-iure-odit/pulls).

#### Building/Testing
To build/test the project locally on your computer:

1. __Clone this repo__<br>
`git clone https://github.com/lambrioanpm/aperiam-iure-odit.git`
...
This package is [Treeware](http://treeware.earth). If you use it in production, then we ask that you [**buy the world a tree**](https://plant.treeware.earth/lambrioanpm/aperiam-iure-odit) to thank us for our work. By contributing to the Treeware forest you’ll be creating employment for local families and restoring wildlife habitats.
